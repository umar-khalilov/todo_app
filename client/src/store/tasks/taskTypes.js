export const TASK_TYPES = Object.freeze({
    ...
    GET_TASK_REQUEST: 'task/getRequest',
    GET_TASK_SUCCESS: 'task/getSuccess',
    GET_TASK_ERROR: 'task/getError',
    GET_TASKS_REQUEST: 'tasks/getRequest',
    GET_TASKS_SUCCESS: 'tasks/getSuccess',
    GET_TASKS_ERROR: 'tasks/getError',
